...
namespace svc_InterviewBack.Migrations
{
    ...
    [Migration("20240623104008_StudentandSchoolStatusResult")]
    partial class StudentandSchoolStatusResult
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("svc_InterviewBack.DAL.RequestResult", b =>
                {
                    ...
                    b.Property<int>("SchoolResultStatus")
                        .HasColumnType("integer");

                    b.Property<int>("StudentResultStatus")
                        .HasColumnType("integer");
